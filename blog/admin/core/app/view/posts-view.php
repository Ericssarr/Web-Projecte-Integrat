...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Nou Article</h4>
      </div>
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-4 control-label">Títol *</label>
    <div class="col-md-6">
      <input type="text" name="title" required class="form-control" id="title" placeholder="Titulo">
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-4 control-label">Breu Descripció *</label>
    <div class="col-md-6">
      <textarea name="brief" required class="form-control" id="brief" placeholder="Descripcion Breve"></textarea>
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-4 control-label">Contingut *</label>
    <div class="col-md-6">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-4 control-label">Imatge destacada (máx. 1920x1080)*</label>
    <div class="col-md-6">
  ...
  <div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
      <button type="submit" class="btn btn-primary">Afegir Article</button>
    </div>
  </div>
</form>
...
<div class="modal fade" id="editModal<?php echo $user->id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-4 control-label">Imatge destacada destacada (máx. 1920x1080)*</label>
    <div class="col-md-6">
      <input type="file" name="image" >
    </div>
  </div>
