...
<input type="hidden" name="kind" value="<?php echo $_GET["kind"];?>">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Cogno,*</label>
    <div class="col-md-6">
      <input type="text" name="lastname" required class="form-control" id="lastname" placeholder="Cognom">
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Nom d'usuari*</label>
    <div class="col-md-6">
      <input type="text" name="username" class="form-control" required id="username" placeholder="Nom d'usuari">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="password" name="password" class="form-control" id="inputEmail1" placeholder="Contrasenya">
    </div>
  </div>
